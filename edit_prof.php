...
<body>
	...
	<form name="form2" action="" method="post">
		...
		<table>
			<tr>
				<td>User ID:</td>
				<td><input type="text" name="uid" value="<?php echo $profdet[0]; ?>" readonly></td>
			</tr>
			<tr></tr><tr></tr><tr></tr>
			<tr>
				<td>Password:</td>
				<td><input type="password" name="pwd" value='<?php echo $profdet[1]; ?>' ></td>
				<!--<td><input type="submit" name="show" value="Submit"></td>-->
			</tr><tr></tr><tr></tr><tr></tr>
			
			<tr>
				<td>Confirm Password:</td>
				<td><input type="password" name="cpwd" value="<?php echo $profdet[1]; ?>" ></td>
			</tr><tr></tr><tr></tr><tr></tr>
			<tr>
			...
			<tr>
				<td>Course:</td>
				<td><select style="width:173px;" name="course" required>
