<?php
	...
	if(isset($_REQUEST['post']))
	{
		...
		if(post_job($jid,$j_title,$j_desc,$c_name,$c_det,$c_loc,$no_of_vac,$exp_needed,$package,$domain,$catagory,$course,$skills,$post_date,$end_date,$date_of_camp_inter,$inter_req))
	...
	<center>
		...
		<table>
			...
			<tr>
				...
				<td><input type="Date" name="date_of_camp_inter" value="" required></td>
			</tr><tr></tr><tr></tr><tr></tr>
			<tr>
		...
		<tr><td></td>
		<td><a href="searchcandidates.php"><input type="button" name="back" value="Back"></a>&nbsp&nbsp&nbsp&nbsp
