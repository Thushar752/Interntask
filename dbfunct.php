...
function checkaccount_typee($uid,$type)
	{
		$conn=connection();
		$flag=true;
			$sql2="select uid,type from userinfo where uid='$uid'";
	...
	function post_job($jid,$j_title,$j_desc,$c_name,$c_det,$c_loc,$no_of_vac,$exp_needed,$package,$domain,$catagory,$course,$skills,$post_date,$end_date,$date_of_camp_inter,$inter_req)
	{
		$conn=connection();
		$sql="insert into jobinfo values('$jid','$j_title','$j_desc','$c_name','$c_det','$c_loc','$no_of_vac','$exp_needed','$package','$domain','$catagory','$course','$skills','$post_date','$end_date','$date_of_camp_inter','$inter_req','yes') ";
		echo "".$sql;
		$nor=mysqli_query($conn,$sql);
	...
	function updatejob($jid,$j_title,$j_desc,$c_name,$c_det,$c_loc,$no_of_vac,$exp_needed,$package,$domain,$catagory,$course,$skills,$post_date,$end_date,$date_of_camp_inter,$inter_req)
	{
		$conn=connection();
		$sql="update jobinfo set job_id='$jid',job_title='$j_title',job_desc='$j_desc',comp_name='$c_name',comp_det='$c_det',location='$c_loc',no_of_vacancy='$no_of_vac',exp_needed='$exp_needed',package='$package',domain='$domain',catagory='$catagory',course='$course',skills='$skills',post_date='$post_date',end_date='$end_date',camp_inter_date='$date_of_camp_inter',inter_req='$inter_req' where job_id='$jid'";
		$nor=mysqli_query($conn,$sql);
		closeconnection($conn);
		if($nor>0)
			return true;
